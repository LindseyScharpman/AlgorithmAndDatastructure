...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    private Node ceiling(Node x, Key key) {
		/*
		 * 如果给定的键key等于BST的根节点的键,那么大于等于key的最小键一定是根节点. 如果给定的键key大于BST的根节点的键,那么大于等于key的最小键一定在根节点的右子树中.
    ...
    public static void main(String[] args) {
        ...
        // StdOut.println(st.isBinaryTree(st.root) + ":" + st.isSelectRankConsistant());
        //
        // String[] ints = { "A", "B", "C", "D", "E", "F", "G",};
        // BST<String, Integer> s = new BST<String, Integer>();
        // s.createPerfectBST(ints);
        // for (String str : s.levelOrder())
        // StdOut.print(str + "  ");
    }
}
