...
public class ex29_BinarySearchIncludeEqualKey {
    ...
    // 在arr里面寻找刚好等于key的元素,如果存在,返回此元素的索引
    // 若存在多个刚好等于key的元素,则返回最右边的元素的索引
    ...
    public static void main(String[] args) {
        ...
        System.out.println(strictUpperBound(3, a));
        System.out.println(strictLowerBound(3, a));

        System.out.println(UpperBound(3, a));
        System.out.println(LowerBound(3, a));
